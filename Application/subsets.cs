...
namespace Array.Application
{
    public partial class Solution: ISolution
    {
        ...
        public List<List<int>> GetAllSubsets(List<int> A){
            ...
            /* bit masking
            since subsets and subsequences can be foemed without continuous elements
            the idea or the observed pattern is
            the set bits of al the numbers from 0 to total number of sets (N) gives all combinations of
            elements of set, making N different subsets including null set
            */
